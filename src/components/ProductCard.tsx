      ...
      >
        ...
        <div className="aspect-[4/5] sm:aspect-[3/4] overflow-hidden bg-gray-200 relative">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-black/80 via-black/60 to-transparent
                         opacity-0 group-hover:opacity-100 transition-opacity duration-700 flex items-center">
        ...
        <div className="absolute top-3 right-3 flex flex-col gap-2 z-10">
          <button className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-white/90 backdrop-blur-sm
                           flex items-center justify-center text-gray-600
                           border border-gray-200 transition-all duration-300
                           hover:bg-white hover:scale-110 group-hover:bg-red-50 group-hover:text-red-500
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6
          ...
          <div className="mb-4">
            ...
            <div className="flex gap-2">
              {['S', 'M', 'L', 'XL'].map((size) => (
                <button
                  key={size}
                  className="w-10 h-10 rounded-lg border-2 border-gray-300 text-gray-700 text-sm font-medium
                           hover:border-gray-900 hover:bg-gray-900 hover:text-white
                           transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-gray-900/20"
                >
                  {size}
                </button>
              ))}
          ...
          {/* Add to Cart Button */}
          <button className="w-full px-4 py-3 rounded-lg bg-gray-900 text-white font-semibold flex items-center justify-center gap-2
