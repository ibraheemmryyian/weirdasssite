...
export function ProductsPage({ onProductClick }: ProductsPageProps) {
  const allProducts = [
    ...
    { name: 'Wool Coat', price: 599, image: '07', category: 'PREMIUM' },
    { name: 'Silk Blouse', price: 189, image: '08', category: 'NEW' },
    { name: 'Denim Jacket', price: 329, image: '09', category: 'CLASSIC' },
    { name: 'Leather Boots', price: 449, image: '10', category: 'LIMITED' },
  ];
